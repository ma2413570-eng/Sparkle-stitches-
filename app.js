...
const sparkleFeatureCss=`${content}`;
(function(){const style=document.createElement('style');style.id='sparkle-final-features';style.textContent=sparkleFeatureCss;document.head.appendChild(style)})();
